...
<form method="post">
<div class="mb-3">
              <label for="capital" class="form-label">Insira um capital</label>
              <input type="number" id="capital" name="capital" class="form-control" required="">
            </div><div class="mb-3">
              <label for="taxa" class="form-label">Insira uma taxa de juros</label>
...
<?php
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        echo "O resultado do juros simples é $juros%";
    }
?>
