...
<form method="POST">
    <div class="mb-3">
        ...
        <input name="nome" type="text" class="form-control" value="<?= htmlspecialchars($adotante['adot_nome']) ?>" required>
    </div>

    <div class="mb-3">
        <label class="form-label">Telefone</label>
        <input name="telefone" type="text" class="form-control" value="<?= htmlspecialchars($adotante['adot_telefone']) ?>">
    </div>

    <div class="mb-3">
        <label class="form-label">CPF</label>
        <input name="cpf" type="text" class="form-control" value="<?= htmlspecialchars($adotante['adot_cpf']) ?>" required>
    </div>
