...
if (isset($_GET['cancelar'])) {
    ...
    try {
        ...
        // Descobre o animal dessa adoção
...
<form method="POST" class="mb-4">
    ...
    <div class="mb-3">
        ...
        <select name="adot_id" class="form-select" required>
            ...
            <?php foreach ($adotantes as $ad): ?>
                <option value="<?= $ad['adot_id'] ?>"><?= htmlspecialchars($ad['adot_nome']) ?></option>
            <?php endforeach; ?>
        </select>
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="date" name="data_adocao" class="form-control" value="<?= date('Y-m-d') ?>" required>
    </div>
...
<table class="table table-striped table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="editar_adocao.php?id=<?= $ad['ado_id'] ?>" class="btn btn-warning btn-sm">Editar</a>
